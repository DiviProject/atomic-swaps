...
// @TODO: Update MainNetParams with on v3 deploy
var MainNetParams = chaincfg.Params{
	...
	Checkpoints: []chaincfg.Checkpoint{
		// @TODO: Update with checkpoints on v3 deploy
	},
...
var TestNet3Params = chaincfg.Params{
	...
	CoinbaseMaturity:         100,
	SubsidyReductionInterval: 210000,
	TargetTimespan:           time.Hour * 24 * 1, // 1 days
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []chaincfg.Checkpoint{
		// @TODO: Update with checkpoints when v3 implements testnet and mainnet checkpoints
	},
